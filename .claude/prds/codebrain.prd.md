...
v0.1 shipped 11 sub-milestones with codebrain feature-complete (commits 4f07b13 through 0a20551). v0.1.1 (commit 4566312) addressed **Gap A** from operator dogfood (framework-level detection + ECC bridge architecture). v0.1.2 (this revision) shipped `.brain/llms.txt` (AEO-convention agent-portable site map) + SKILL.md reciprocity test, informed by independent agentctx-idea research. Two milestones remain on the post-MVP roadmap, both addressing additional operator-discovered gaps:
