...
| index.md | `.brain/index.md` |
| log.md (with grep-able prefix) | `.brain/log.md` — `## [YYYY-MM-DD] <op> \| <subject>` convention |
| Entity / concept pages | `.brain/concepts/` cross-cutting pages |
| Compounding artifact (file good answers back) | `/brain query` outputs can be filed into `.brain/concepts/` |
